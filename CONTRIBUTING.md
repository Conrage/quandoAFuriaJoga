...
`git clone https://github.com/Conrage/quandoAFuriaJoga.git`
...
Você pode criar uma issue [aqui](https://github.com/Conrage/quandoAFuriaJoga/issues), mas, lembre-se de ser claro e informar o máximo de detalhes possíveis.
